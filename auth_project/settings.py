...
if DEBUG:
       ...
       ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'Users_management-0y19.onrender.com').split(',')
       ALLOWED_HOSTS.append('Users_management-0y19.onrender.com')  # Ensure the host is included
